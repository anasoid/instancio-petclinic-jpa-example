 ...
 * Date :   1/4/25
 */
public abstract class NamedEntityDataGenerator<T extends NamedEntity> extends AbstractEntityDataGenerator<T> {
    @Override
    protected Map<String, Object> getFunctionalIdParams(T entity) {
        return Map.of("name", (Object) entity.getName());
    }

    @Override
    protected String getFunctionalIdQuery() {
        return "select e from {0} e where e.name=:name";
    }
}
